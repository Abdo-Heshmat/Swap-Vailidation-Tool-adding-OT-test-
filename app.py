...
# This block forces the entire app to change based on the toggle
...
st.markdown(f"""
    ...
    /* Style the containers to match the theme */
...
# --- 3. TOP BAR (Theme Toggle on Right) ---
    ...
    with col:
        ...
        for week in ["Current", "Next"]:
            ...
            with st.container(border=True):
                ...
                with t1:
                    s_time = st.selectbox(f"Start {week}{i}", hours, index=17 if i==1 and week=="Current" else 9, key=f"s{i}_{week}")
                with t2:
                ...
                with t3:
                    ...
                    # Use disabled text input to keep UI identical
